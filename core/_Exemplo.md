...
//Rota de exemplo
$router->get('/admin/exemplo/lista',       'ExemploController@index');
$router->get('/admin/exemplo/form',        'ExemploController@form');
$router->get('/admin/exemplo/form/{id}',   'ExemploController@form');
$router->post('/admin/exemplo/form',       'ExemploController@action');
$router->get('/admin/exemplo/delete/{id}', 'ExemploController@delete');
